...
import swaglabs.pom.util.RandomIntGenerator;
...
public class ProductsPage extends Page {
    ...
    private By menuButton = new By.ByCssSelector("#react-burger-menu-btn");
    private By logoutButton = new By.ByCssSelector("#logout_sidebar_link");
    ...
    public int clickRandomProductImage() {
        ...
        // System.out.println("Clicked product in position " + (randInt + 1) + " (id=" +
        // id + ")");
